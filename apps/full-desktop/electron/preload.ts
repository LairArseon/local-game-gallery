...
const api: GalleryApi = {
  ...
  openExternalUrl: (payload: OpenExternalUrlPayload) => ipcRenderer.invoke('gallery:open-external-url', payload),
  ...
  listLaunchCandidates: (payload: ListLaunchCandidatesPayload): Promise<ListLaunchCandidatesResult> => ipcRenderer.invoke('gallery:list-launch-candidates', payload),
  ...
  importStagedGameArchive: (payload: ImportStagedGameArchivePayload): Promise<ImportStagedGameArchiveResult> => ipcRenderer.invoke('gallery:import-staged-game-archive', payload),
