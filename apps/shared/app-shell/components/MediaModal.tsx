...
type MediaUploadProgressLike = {
  completed: number;
  total: number;
  phase: string;
};

type MediaModalProps<TGame extends GameWithMedia> = {
  game: TGame | null;
  isOpen: boolean;
  isMediaSaving: boolean;
  mediaUploadProgress?: MediaUploadProgressLike | null;
...
export function MediaModal<TGame extends GameWithMedia>({
  game,
  isOpen,
  isMediaSaving,
  mediaUploadProgress,
