        ...
        <label className="field">
          ...
          >
            ...
            <button
              ...
              type="button"
              onClick={onPickRoot}
              disabled={isSaving || !isGamesRootEditable}
              aria-label={chooseLibraryFolderLabel}
              title={!isGamesRootEditable ? gamesRootLockedReason : chooseLibraryFolderLabel}
            >
              <FolderOpen size={16} aria-hidden="true" />
            </button>
          </div>
          {!isGamesRootEditable ? (
            <small className="field__hint">{gamesRootLockedReason}</small>
          ) : null}
        </label>
