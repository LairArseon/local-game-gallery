 ...
 *
 * New to this project: start here for dropdown interaction behavior (open/close, keyboard navigation, option focus), then trace its callbacks in setup/filter/modal parents for state changes.
 */
