...
export function useContextMenuListeners({
  ...
  }, [games, openGameDetailFromPath, openFolderInExplorer, openMetadataModal, openPicturesModal, playGame, setStatus, toggleGameVaultMembership]);
  ...
  useEffect(() => {
    const dispose = window.gallery.onVaultContextMenuAction((payload) => {
